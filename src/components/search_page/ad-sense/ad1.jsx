...
import AddImg from '@/public/images/ads/ad1.jpeg'

function Ad1() {
  return (<div className={`w-4/5 relative aspect-[16/4] bg-no-repeat bg-cover bg-center rounded mb-8 overflow-visible flex items-center justify-between cursor-pointer`}
